			...
			<table class="min-w-full divide-y divide-gray-300">
				<thead class="bg-gray-50">
					<tr>
						...
						<th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">WhatsApp</th>
					...
					@if ($this->results->isNotEmpty())
						@foreach ($this->results as $row)
							<tr class="even:bg-gray-50">
								...
								<td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500">{{ $row->name }}</td>
								<td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500">{{ $row->email }}</td>
								<td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500">{{ $row->phone ?? '-' }}</td>
								<td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500">{{ $row->getMeta('whatsapp_number') ?? '-' }}</td>
