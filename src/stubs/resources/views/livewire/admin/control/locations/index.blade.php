                ...
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        @if ($this->group === 'country')
                            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Dial Code</th>
                        @endif
                        ...
                        @foreach ($this->results as $row)
                            <tr class="even:bg-gray-50">
                                ...
                                @if ($row->type == 'location' && $this->group === 'country')
                                    <td class="px-3 py-4 text-sm whitespace-nowrap text-gray-500">{{ $row->getMeta('dial_code', 'N/A') }}</td>
                                @endif
