...
new class extends Component {
    ...
    public function update(): void
    {
        ...
        try {
            ...
            $this->notifySuccess(__('Availability updated successfully!'));
        } catch (\Exception $e) {
            $this->notifyError(__('Failed to update availabilities. Please try again: ' . $e->getMessage()));
        }
    }
    ...
    {
        $this->notifyInfo(__('Availability update cancelled!'));
    }
}; ?>

<div>
    <x-admin-panel>
        <x-slot name="header">{{ __('Update Availability') }}</x-slot>
        <x-slot name="desc">
            {{ __('Update the availabilities type details.') }}
        </x-slot>
                ...
                <div class="space-y-12">
                    <div class="grid grid-cols-1 gap-x-8 gap-y-10 pb-12 md:grid-cols-3">
                        <div>
                            ...
                            <p class="mt-1 text-sm/6 text-gray-600 dark:text-gray-300">Update the availabilities type information below.</p>
                        </div>
                            ...
                            <div class="col-span-full">
                                ...
                                <div class="mt-2">
                                    <div
                                        ...
                                        <input type="text" id="name" wire:model="name" placeholder="e.g. 1BR, 2BR, Studio"
