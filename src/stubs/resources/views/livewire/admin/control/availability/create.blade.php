...
new class extends Component {
    ...
    public function save(): void
    {
        ...
        try {
            ...
            $this->notifySuccess(__('Availability created successfully!'));
        } catch (\Exception $e) {
            $this->notifyError(__('Failed to create availabilities. Please try again: ' . $e->getMessage()));
        }
    }
    ...
    {
        $this->reset(['name', 'description']);
        $this->notifyInfo(__('Availability creation cancelled!'));
    }
}; ?>

<div>
    <x-admin-panel>
        <x-slot name="header">{{ __('Add New Availability') }}</x-slot>
        <x-slot name="desc">
            {{ __('Add a new availabilities type to the system (e.g., Available, Unavailable, Coming Soon).') }}
        </x-slot>
            ...
            <form wire:submit="save">
                <div class="space-y-12">
                    <div class="grid grid-cols-1 gap-x-8 gap-y-10 pb-12 md:grid-cols-3">
                        <div>
                            <h2 class="text-base/7 font-semibold text-gray-900 dark:text-gray-100">Availability Details</h2>
                            <p class="mt-1 text-sm/6 text-gray-600 dark:text-gray-300">Define a availabilities type that will be displayed in the application.</p>
                        </div>
                        ...
                        <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
                            <div class="col-span-full">
                                ...
                                <div class="mt-2">
                                    <div
                                        ...
                                        <input type="text" id="name" wire:model="name" placeholder="e.g. Available, Unavailable, Coming Soon, 3BR"
                            ...
                            <div class="col-span-full">
                                ...
                                <p class="mt-3 text-sm/6 text-gray-600 dark:text-gray-300">Write a description for the availabilities type.</p>
                            </div>
