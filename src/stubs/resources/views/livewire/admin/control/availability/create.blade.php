            ...
            <form wire:submit="save">
                <div class="space-y-12">
                    <div class="grid grid-cols-1 gap-x-8 gap-y-10 pb-12 md:grid-cols-3">
                        <div>
                            <h2 class="text-base/7 font-semibold text-gray-900">Availability Details</h2>
                            <p class="mt-1 text-sm/6 text-gray-600">Define a availabilities type that will be displayed in the application.</p>
                        </div>
                        ...
                        <div class="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
                            ...
                            <div class="col-span-full">
                                ...
                                <p class="mt-3 text-sm/6 text-gray-600">Write a description for the availabilities type.</p>
                            </div>
